...
- [x] 6. Substituir a interface específica por uma configuração de fonte para CSV e XLSX.
- [x] 7. Criar tabelas de fontes, lotes, bronze e registros canônicos no SQLite.
- [x] 8. Implementar normalização, validação de tipos e relatório de inconsistências.
- [x] 9. Implementar deduplicação por checksum, versão e impressão digital canônica.
- [x] 10. Testar dois órgãos, dois formatos, reprocessamento e consulta de proveniência.
