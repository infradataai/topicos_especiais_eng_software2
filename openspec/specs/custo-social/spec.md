# custo-social Specification

## Purpose

Calcular o custo social de cada ocorrência pelo produto escalar entre o vetor de contagens e o vetor de custos médios do IPEA, com a base monetária declarada.
